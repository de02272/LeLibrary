...
public abstract class LeClientService extends Service {
    ...
    public class LeClientServiceBinder extends Binder {
        ...
        public boolean connect(BluetoothDevice device, long timeout) {
            ...
            gatt = device.connectGatt(org.die_fabrik.lelib.client.LeClientService.this, false, leGattCallback);
            return gatt != null;
        }
        ...
        public boolean startScan(int reportDelay, int scanMode, long timeout, boolean onlyProfileServices) {
            Log.v(TAG, "startScan(reportDelay: " + reportDelay + ", scanMode: "
                    + LeUtil.getScanMode(org.die_fabrik.lelib.client.LeClientService.this, scanMode) + ", timeout: " + timeout
    ...
    private class LeScanCallback extends android.bluetooth.le.ScanCallback {
        ...
        public void onScanFailed(int errorCode) {
            Log.v(TAG, "onScanFailed:" + LeUtil.getScanErrorCode(org.die_fabrik.lelib.client.LeClientService.this, errorCode) + "(" + errorCode + ")");
    ...
    private class LeGattCallback extends BluetoothGattCallback {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            Log.v(TAG, "onCharacteristicRead characteristic: " + characteristic.getUuid().toString()
                    + ", status: " + LeUtil.getGattStatus(org.die_fabrik.lelib.client.LeClientService.this, status));
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            Log.i(TAG, "onConnectionStateChange() " + "status: "
                    + LeUtil.getGattStatus(org.die_fabrik.lelib.client.LeClientService.this, status) + ", newState: "
                    + LeUtil.getGattState(org.die_fabrik.lelib.client.LeClientService.this, newState));
            if (status == BluetoothGatt.GATT_SUCCESS) {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            Log.v(TAG, "onServicesDiscovered() status: "
                    + LeUtil.getGattStatus(org.die_fabrik.lelib.client.LeClientService.this, status));
